...
// Connecting to MySQL Database.
 ...
 $Sql_Query = "insert into booked (book_ser, book_car, book_start, book_end, price, stat, star, cus_id, book_date ) values ('$book_ser','$book_car','$book_start','$book_end','$price','$stat','$star','$cus_id','$book_date')";
